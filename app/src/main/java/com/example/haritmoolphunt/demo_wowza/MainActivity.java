package com.example.haritmoolphunt.demo_wowza;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goCoder = WowzaGoCoder.init(getApplicationContext(), "GOSK-CE43-0103-0940-0E18-8644");
        ...
        goCoderBroadcastConfig.setHostAddress("3cbde5.entrypoint.cloud.wowza.com");
        goCoderBroadcastConfig.setPortNumber(1935);
        goCoderBroadcastConfig.setApplicationName("app-80e4");
        goCoderBroadcastConfig.setStreamName("1be9c7ad");
